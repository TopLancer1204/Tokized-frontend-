...
const menu = [
  {
    ...
    groupItems: [
      ...
      { key: 'sell_property', to: '/admin/sell_property', name: 'Questions', icon:ReferralSvg, iconActive: ReferralOnSvg },
      { key: 'answer', to: '/admin/answer', name: 'Answers', icon:ReferralSvg, iconActive: ReferralOnSvg }
    ]
  },
  {
    groupName: 'ACCOUNT',
