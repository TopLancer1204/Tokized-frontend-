...
const AdminQuestion = React.lazy(() => import('./views/Admin/AdminQuestion'));
const AdminAnswer = React.lazy(() => import('./views/Admin/AdminAnswer'));
...
const routes = [
  ...
  { path: '/admin/sell_property', name: 'AdminQuestion', component: AdminQuestion },
  { path: '/admin/answer', name: 'AdminAnswer', component: AdminAnswer },
